...
class FdView extends SampleCvViewBase {
	...
	public FdView(Context context) {
		...
		try {
			...
			// ----------------------------End of inputting cascade files-----------------
	...
	protected Bitmap processFrame(VideoCapture capture) {
		...
		if (mDetectorType == JAVA_DETECTOR) {
			...
			for (int i = 0; i < facesArray.length; i++) {
				...
				Core.rectangle(mGray, r.tl(), r.br(), new Scalar(0, 0, 0, 255), 3);
				Core.rectangle(mRgba, r.tl(), r.br(), new Scalar(0, 0, 0, 255), 3);
				...
				Core.rectangle(mRgba, eyearea_left.tl(), eyearea_left.br(), new Scalar(0, 255, 0, 255), 2);
				Core.rectangle(mRgba, eyearea_right.tl(), eyearea_right.br(), new Scalar(0, 255, 0, 255), 2);
	...
	private Mat get_template(CascadeClassifier clasificator, Rect area, int size) {
		...
		for (int i = 0; i < eyesArray.length;) {
			...
			Core.rectangle(mRgba, eye_template.tl(), eye_template.br(), new Scalar(255, 255, 0, 255), 2);
