	...
	private BaseLoaderCallback mOpenCVCallBack = new BaseLoaderCallback(this) {
		...
		public void onManagerConnected(int status) {
			...
			case LoaderCallbackInterface.SUCCESS: {
				...
				RelativeLayout.LayoutParams vsek = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, 400);
				...
				RelativeLayout.LayoutParams matching_method_param = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
				...
				btn.setText("Begin Sampling");
				RelativeLayout.LayoutParams btnp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
				btnp.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
				btn.setId(2);

				btn.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {mView.resetLearFramesCount();
					}
				});
